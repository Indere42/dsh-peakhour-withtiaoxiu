window.__ModuleLoader__.load({ id: "dsh-peakhour-withtiaoxiu", factory: (require) => {
	var module = { exports: {} };
...
const name = 'dsh-peakhour-withtiaoxiu'
 ...
 */
function formatBeijingClock(minuteOfDay) {
 ...
 * @returns {string} The label.
 */
function formatBeijingMoment(ms) {
...
function apply(ctx) {
  ...
  ctx?.effect?.(() => () => {
    ...
    row?.remove()
		...
		exports.formatBeijingClock = formatBeijingClock;
		exports.formatBeijingMoment = formatBeijingMoment;
		exports.rowSummary = rowSummary;
